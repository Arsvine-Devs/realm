...
- Realm runtime content uses the static Content origin from `config/site-config.mjs`; protected reads use the static Auth origin and `CONTENT_SERVICE_CLIENT_*` credentials server-side.
