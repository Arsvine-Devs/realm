...
```text
tests/app/document-bootstrap-performance.browser.test.ts
tests/app/main-layout-performance.test.tsx
tests/features/hud/performance-tiers.test.ts
tests/features/hud/useAdaptivePerformance.browser.test.ts
tests/features/hud/left-panel-performance.test.tsx
tests/features/hud/webgl-context-loss.browser.test.ts
