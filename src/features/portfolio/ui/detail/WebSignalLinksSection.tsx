...
interface WebSignalLinksSectionProps {
  links: WebSignalLink[];
...
export default function WebSignalLinksSection({
  links,
  sectionRef,
  styles,
  title,
}: WebSignalLinksSectionProps) {
  return (
    <section className={styles.linksSection} ref={sectionRef} data-nav-id="signal">
